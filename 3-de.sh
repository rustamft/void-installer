...
case $desktop_environment in
  ...
  "KDE")
    packages="$packages xorg-minimal sddm sddm-kcm ntp plasma-desktop kf6-kded kwallet-pam plasma-nm bluedevil plasma-pa kpipewire kinfocenter dmidecode kde-gtk-config xdg-desktop-portal-kde pcmanfm-qt gvfs ark unrar alacritty" ;;
  *)
    printf '\nInstallation failed'
    exit
    ;;
