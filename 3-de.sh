...
case $desktop_environment in
  "GNOME")
    ...
    ;;
  "KDE")
    xbps-install -Sy xorg-minimal sddm sddm-kcm ntp plasma-desktop kwallet-pam plasma-pa kpipewire xdg-desktop-portal-kde xdg-user-dirs pcmanfm-qt gvfs ark unrar alacritty
